...
// ForecastProvider fetches the full available forecast window without
// exposing Surfline's response format to the TUI.
type ForecastProvider interface {
	Forecast(ctx context.Context, spotID string) (Forecast, error)
}

// ForecastDetailsProvider fetches the richer wind, weather, and tide data shown
